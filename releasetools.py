...
# Firmware - chiron-firmware
def FullOTA_InstallEnd(info):
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/abl.elf"), "firmware-update/abl.elf")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/BTFM.bin"), "firmware-update/BTFM.bin")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/cmnlib64.mbn"), "firmware-update/cmnlib64.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/cmnlib.mbn"), "firmware-update/cmnlib.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/devcfg.mbn"), "firmware-update/devcfg.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/hyp.mbn"), "firmware-update/hyp.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/keymaster.mbn"), "firmware-update/keymaster.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/logfs_ufs_8mb.bin"), "firmware-update/logfs_ufs_8mb.bin")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/NON-HLOS.bin"), "firmware-update/NON-HLOS.bin")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/rpm.mbn"), "firmware-update/rpm.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/storsec.mbn"), "firmware-update/storsec.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/tz.mbn"), "firmware-update/tz.mbn")
    info.output_zip.write(os.path.join(TARGET_DIR, "../device/xiaomi/chiron-firmware/firmware-update/xbl.elf"), "firmware-update/xbl.elf")
